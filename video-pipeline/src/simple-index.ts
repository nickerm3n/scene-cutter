...
import { SimpleContentProcessor } from './services/simple-content-processor.js'
...
async function main() {
  try {
    console.log('🚀 Starting Simple Course Content Pipeline...')
    ...
    const processor = new SimpleContentProcessor(config)
