...
├── video-pipeline/             # Python пайплайн для обработки видео
├── ai-services/                # AI/LLM сервисы для обработки контента
├── browser-script/             # Скрипты для браузера
...
Python-система обработки видео с поддержкой:
...
TypeScript-сервисы для AI/LLM обработки контента с поддержкой vision:
- Интеграция с OpenAI GPT-4o для обработки контента и изображений
- Обработка визуального контента с автоматическим извлечением кадров
- Парсинг HTML и извлечение транскриптов
- Генерация структурированного контента с интеграцией изображений
- Сопоставление изображений с временными метками транскрипта
...
# Зависимости для видео пайплайна
cd ../video-pipeline
pip install -r requirements.txt

# Зависимости для AI сервисов
cd ../ai-services
npm install
```
